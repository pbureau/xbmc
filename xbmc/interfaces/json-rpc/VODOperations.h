...
namespace JSONRPC
{
  class CVODOperations: CFileItemHandler
  {
  public:
    ...
    static JSONRPC_STATUS ActionSearch(const std::string &method, ITransportLayer *transport, IClient *client, const CVariant &parameterObject, CVariant &result);
  };
}
